# themes/everforest/ghostty.config
...
## Diff
```diff
+[Added entire ghostty.config file with everforest color scheme for Ghostty terminal]
```

## Reasoning
Created to replace the deleted alacritty.toml - provides everforest color scheme for the new Ghostty terminal instead of Alacritty.
